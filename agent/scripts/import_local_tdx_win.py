...
logger = logging.getLogger('import_local_tdx_win')
...
def import_market_data(tdx_path, db_path):
    ...
    if not day_files:
        logger.warning('未找到任何 .day 数据文件，请确认通达信已下载日线数据并关闭软件。')
        return
